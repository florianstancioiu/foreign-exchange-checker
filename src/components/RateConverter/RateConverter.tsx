...
const RateConverter = ({
  ...
  return (
    <div className="p-4 rounded-2xl border border-neutral-500 bg-neutral-600 w-full md:p-5 light:bg-blue-200 light:border-neutral-100">
      <p
        className="uppercase text-sm text-neutral-100 mb-5 leading-[120%] tracking-[1px] light:text-neutral-900"
        data-testid="rate_converter_title"
      >
        {title}
      </p>
      <div className="flex justify-between items-center">
        {isReceive ? (
          <p
            ...
            data-testid="rate_converter_is_receive"
          >
