  ...
  return (
    <section className="px-4 mb-10">
      ...
      <div className="shadow-check-rate">
        <div className="p-4 bg-neutral-700 rounded-[20px] rounded-br-none rounded-bl-none border-b border-dashed border-neutral-500">
        ...
        <div className="p-4 bg-neutral-700 rounded-[20px] rounded-tr-none rounded-tl-none">
          <p className="uppercase text-center font-normal leading-[100%] text-[10px] mb-4">
            1 USD = 0.8530 EUR
          </p>
