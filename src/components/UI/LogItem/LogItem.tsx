...
const LogItem = ({
  ...
  return (
    <li className="border border-neutral-500 rounded-[10px] bg-neutral-600 light:bg-blue-200 light:border-blue-300 p-3 flex gap-x-2.5 justify-between items-center hover:border-neutral-300 light:hover:border-blue-400">
