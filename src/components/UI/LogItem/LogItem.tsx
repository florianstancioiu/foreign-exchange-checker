...
const LogItem = ({
  ...
  return (
    <section className="border border-neutral-500 rounded-[10px] bg-neutral-600 light:bg-blue-100 light:border-blue-200 p-3 flex gap-x-2.5 justify-between items-center hover:border-neutral-300">
      ...
      <div className="flex justify-between items-center gap-x-2.5 md:gap-x-4">
        ...
        <button
          ...
          className="size-8 border border-neutral-500 light:bg-red-500 light:border-red-600 rounded-[10px] grid place-content-center cursor-pointer focus-visible:outline-lime-500 focus-visible:outline-2 focus-visible:outline-offset-3 focus-visible:rounded-lg hover:bg-neutral-500"
        >
