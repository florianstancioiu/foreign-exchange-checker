...
const CurrencyPickerItem = ({
  ...
  return (
    <button
      type="button"
      className="border border-neutral-600 bg-neutral-600 rounded-sm py-3 px-2 flex justify-between items-center w-full cursor-pointer hover:border-neutral-200 focus-visible:border-lime-500 focus-visible:outline-0"
    >
